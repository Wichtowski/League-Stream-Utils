...
const api = {
  ...
  checkFileExists: (filePath: string) =>
    ipcRenderer.invoke('assets:exists', filePath),
  getAssetCacheStats: () =>
    ipcRenderer.invoke('assets:cache-stats'),
  clearAssetCache: () =>
    ipcRenderer.invoke('assets:clear-cache'),
  checkAssetIntegrity: () =>
    ipcRenderer.invoke('assets:check-integrity'),
  listAssetTree: () =>
  ...
  loadChampionsCache: () =>
    ipcRenderer.invoke('champions:load-cache'),
  ...
  obsGetScenes: () =>
    ipcRenderer.invoke('obs:get-scenes'),
  obsSwitchScene: (sceneName: string) =>
    ipcRenderer.invoke('obs:switch-scene', sceneName),
  obsGetStreamStatus: () =>
    ipcRenderer.invoke('obs:stream-status'),
  obsStartStream: () =>
    ipcRenderer.invoke('obs:start-stream'),
  obsStopStream: () =>
    ipcRenderer.invoke('obs:stop-stream'),

  // System
  getUserDataPath: () =>
    ipcRenderer.invoke('util:user-data-path'),
  getPlatform: () =>
    ipcRenderer.invoke('util:platform'),
  getVersion: () =>
    ipcRenderer.invoke('util:app-version'),

  // Database
  getDatabaseCollections: () =>
    ipcRenderer.invoke('db:collections'),
  ...
  getBackups: () =>
    ipcRenderer.invoke('db:get-backups'),
  restoreBackup: (backupId: string) =>
    ipcRenderer.invoke('db:restore-backup', backupId),
  deleteBackup: (backupId: string) =>
    ipcRenderer.invoke('db:delete-backup', backupId),

  // App mode
  getAppMode: () =>
    ipcRenderer.invoke('util:get-app-mode'),
  setAppMode: (mode: string) =>
    ipcRenderer.invoke('util:set-app-mode', mode),
