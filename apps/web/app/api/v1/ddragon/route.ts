...
import { getLatestVersion, getAllVersions, fetchItems, fetchSummonerSpells, fetchRunes } from '@lsu/riot-api/ddragon';
...
export async function GET(request: NextRequest) {
  ...
  try {
    switch (type) {
      ...
      default:
        return error('type param required: versions | items | runes | summoner-spells | latest-version');
    }
  } catch {
