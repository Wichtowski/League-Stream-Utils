...
async function testChampionsBlueprint() {
  ...
  try {
    ...
    console.log("\n2. Downloading champions blueprint for version 15.17.1...");
    await championsBlueprintDownloader.downloadChampionsBlueprint("15.17.1");
    console.log("✅ Champions blueprint for 15.17.1 downloaded successfully!");
