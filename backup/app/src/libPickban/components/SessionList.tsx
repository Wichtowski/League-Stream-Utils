                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        <Link
                          href={`/modules/draft/config/${session._id}`}
                          target="_blank"
                        ...
                        <Link
                          href={`/modules/draft/game/${session._id}?team=blue`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <Link
                          href={`/modules/draft/game/${session._id}?team=red`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <Link
                          href={`/modules/draft/game/${session._id}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <Link
                          href={`/modules/draft/obs/${session._id}`}
                          target="_blank"
                          rel="noopener noreferrer"
