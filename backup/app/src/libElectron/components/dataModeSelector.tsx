...
import { assetDownloaderManager } from "@lib/services/assets/downloader-manager";
          ...
          <div className="flex items-start space-x-3">
            <div
              className={`
                            ...
                            ${useLocalData ? "border-green-500 bg-green-500" : "border-gray-400"}
                        `}
            >
              {useLocalData && (
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Store all data locally on your computer (%appdata%). No internet connection required. You&apos;ll be
                automatically logged in as admin with full access to all features.
              </p>
              <div className="mt-2 p-2 bg-green-900/30 border border-green-600/50 rounded text-green-200 text-xs">
                <strong>Note:</strong> Local data mode uses MongoDB Memory Server. No system MongoDB installation
                required - the app will automatically start a local MongoDB instance.
              </div>
        ...
        >
          <div className="flex items-start space-x-3">
            <div
              className={`
                            w-5 h-5 rounded-full border-2 mt-0.5 
                            ${!useLocalData ? "border-blue-500 bg-blue-500" : "border-gray-400"}
                        `}
            >
              {!useLocalData && (
                <div className="w-full h-full flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Use the web-based system with Cloud storage. Requires user registration and internet connection. Data is
                stored in the cloud and accessible from anywhere.
              </p>
              <div className="flex items-center space-x-4 mt-2 text-xs">
