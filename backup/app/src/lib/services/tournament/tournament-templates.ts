...
import { TournamentData } from "@libElectron/types";
...
interface TournamentTemplate {
  ...
  // Tournament settings
  format: "BO1" | "BO3" | "BO5";
  tournamentStructure: "Ladder" | "Swiss into Ladder" | "Round Robin into Ladder" | "Groups";
  maxTeams: number;
...
class TournamentTemplateService {
  ...
  private loadDefaultTemplates(): void {
    const leagueStandard: TournamentTemplate = {
      ...
      description: "Standard League tournament format with BO3 matches and professional overlay design",
      version: "1.0.0",
            ...
            sources: [
              {
                ...
                type: "browser_source",
                settings: {
                  url: "http://localhost:3000/draft/obs",
                  width: 1920,
                  height: 1080
                }
              },
  ...
  async createTournamentFromTemplate(templateId: string, settings: TournamentSettings): Promise<TournamentData> {
