...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const configUrl = `${baseUrl}/modules/draft/static/${sessionId}/config`;
  const blueTeamUrl = `${baseUrl}/modules/draft/static/${sessionId}/game?team=blue`;
  const redTeamUrl = `${baseUrl}/modules/draft/static/${sessionId}/game?team=red`;
  const spectatorUrl = `${baseUrl}/modules/draft/static/${sessionId}/game`;
  const obsUrl = `${baseUrl}/modules/draft/static/${sessionId}/obs`;
