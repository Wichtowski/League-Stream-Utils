...
import { draftContent } from "@libdraft/components/draftContent";
...
export default function StaticdraftPage() {
  ...
  const fetchSessions = useCallback(async () => {
    try {
      ...
      const response = await authenticatedFetch(`${API_BASE_URL}/draft/sessions`);
  ...
  return (
    <PageWrapper
      loading={loading}
      breadcrumbs={[
        { label: "Pick & Ban", href: "/modules/draft" },
