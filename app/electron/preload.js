...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  saveTeamLogo: (fileBuffer, fileName) => ipcRenderer.invoke("save-team-logo", fileBuffer, fileName),
  saveTournamentLogo: (fileBuffer, fileName) => ipcRenderer.invoke("save-tournament-logo", fileBuffer, fileName),
