          ...
          {selectedTournament && selectedTeam && (
            <div className="mt-6 p-4 bg-gray-700 rounded-lg">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Register <span className="text-green-400 font-medium">{selectedTeamData?.name}</span> to{" "}
                    <span className="text-blue-400 font-medium">{selectedTournamentData?.name}</span>
                  </p>
                </div>
                <button
              ...
              <div className="text-xs text-gray-400 space-y-1">
                <p>
                  🔧 <strong>Admin Bypass:</strong> This registration will ignore:
                </p>
