...
export const MainTitle = ({ 
  ...
  return (
    <div 
      ...
      `}
      style={{
        animation: animationState === 'fade-in' ? 'fadeIn 0.5s ease-in-out forwards' : 
                  animationState === 'fade-out' ? 'fadeOut 0.5s ease-in-out forwards' : 'none'
      }}
    >
      <div className="bg-gradient-to-r from-gray-900/95 via-gray-800/95 to-gray-900/95 backdrop-blur-sm rounded-lg px-8 py-4 shadow-2xl border border-gray-600/50">
        <h1 className="text-3xl font-bold text-white text-center tracking-wide drop-shadow-lg">
          {title}
        </h1>
      </div>
    </div>
