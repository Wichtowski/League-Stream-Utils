...
export const StreamBannerModel = getModel<StreamBannerDoc>("StreamBanner", StreamBannerSchema);
...
export type StreamBannerDoc = InferSchemaType<typeof StreamBannerSchema>;
