...
export const MODULES: ModuleCard[] = [
  {
    ...
    name: "Teams",
    description:
      "Create and manage tournament teams with player rosters and information",
    icon: "👥",
    path: "/modules/teams",
  ...
  },
  {
    ...
    name: "Tournaments",
    description:
      "Create and manage tournaments with brackets, schedules, and settings",
    icon: "🏆",
  ...
  },
  {
    ...
    description:
      "Register any team to any tournament with admin privileges and bypass restrictions",
    icon: "🔧",
    path: "/modules/tournaments",
  ...
  },
  {
    ...
    name: "Camera Setup",
    description:
      "Configure player stream cameras and fallback images for broadcasting",
    icon: "📹",
  ...
  },
  {
    ...
    description:
      "Browse League of Legends champions abilities with stats and information",
    icon: "⚡",
  ...
  },
  {
    ...
    name: "Commentators",
    description:
      "Manage commentators and their predictions for the selected tournament",
    icon: "🗣️",
