...
export const GameSessionModel = models.GameSession ||
  model('GameSession', GameSessionSchema);

export const UserModel = models.User ||
  model('User', UserSchema);

export const CameraTeamModel = models.CameraTeam ||
  model('CameraTeam', CameraTeamSchema);

export const TeamModel = models.Team ||
  model('Team', TeamSchema);

export const TournamentModel = models.Tournament ||
  model('Tournament', TournamentSchema);

export const BracketModel = models.Bracket ||
  model('Bracket', BracketSchema);

export const CameraSettingsModel = models.CameraSettings ||
  model('CameraSettings', CameraSettingsSchema);

export const ChampionModel = models.Champion ||
  model('Champion', new Schema({
