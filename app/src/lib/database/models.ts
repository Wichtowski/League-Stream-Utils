...
export const CameraTeamModel =
  models.CameraTeam || model("CameraTeam", CameraTeamSchema);
...
export const CameraSettingsModel =
  models.CameraSettings || model("CameraSettings", CameraSettingsSchema);
...
export const SecurityEventModel =
  models.SecurityEvent || model("SecurityEvent", SecurityEventSchema);
