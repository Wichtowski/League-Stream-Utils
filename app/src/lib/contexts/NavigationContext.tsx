...
type NavigationModule = 'home' | 'auth' | 'champ-ability' | 'pickban/static' | 'cameras' | 'modules' | 'tournaments' | 'teams' | 'settings' | 'leagueclient' | 'sponsors' | 'matches' | 'commentators' | null;
