...
import { LastSelectedTournament } from "@/lib/utils/storage/tournament-storage";
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          {module.status === "coming-soon" && (
            <span className={`bg-gradient-to-br ${reversedColor} text-white px-2 py-1 rounded text-xs font-semibold disabled`}>
              COMING SOON
            </span>
          )}
        </div>
