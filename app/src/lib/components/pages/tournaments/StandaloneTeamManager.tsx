...
export const StandaloneTeamManager = ({
  tournament,
  onClose,
  onTeamAdded,
}: StandaloneTeamManagerProps): React.ReactElement => {
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-400">
                Create a team specifically for {tournament.name}
              </p>
            </div>
            <button
              ...
              {selectedTeamData && (
                <div className="text-xs text-gray-400 space-y-1">
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-1">
                    ...
                    <li>
                      Players: {selectedTeamData.players.main.length}/5 main
                      roster
                    </li>
                    <li>
                      Substitutes: {selectedTeamData.players.substitutes.length}
                    </li>
                  </ul>
                </div>
              )}
