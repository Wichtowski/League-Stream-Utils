...
export const TournamentCreationForm = ({
  ...
  const handleCreateTournament = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        !cleanedFormData.requireRegistrationDeadline ||
        !cleanedFormData.registrationDeadline
      ) {
      ...
      if (
        ...
        !cleanedFormData.phaseMatchFormats.default
      ) {
        cleanedFormData.phaseMatchFormats = {
          ...cleanedFormData.phaseMatchFormats,
      ...
      const result = await createTournament(
        cleanedFormData as CreateTournamentRequest,
      );
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...
                  registrationDeadline: e.target.checked
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Round Robin into Ladder">
        ...
        {(formData.tournamentFormat === "Swiss into Ladder" ||
          ...
          <div className="border border-gray-600 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-400 mt-2">
              Configure different match formats for each tournament phase. This
              allows for progressive intensity (e.g., BO1 groups → BO3 playoffs
              → BO5 finals).
            </p>
          </div>
        )}
          ...
          {formData.logo?.type === "url" && (
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                URL to your tournament logo image
              </p>
            </div>
          )}
        ...
        <div>
          <label className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, fearlessDraft: e.target.checked })
              }
              className="rounded"
            />
          ...
          <p className="text-sm text-gray-400 mt-1">
            Champions picked/banned in previous games cannot be used again in
            the series
          </p>
        </div>
