    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-900 bg-opacity-50 rounded-lg p-4">
        ...
        <p className="text-xs text-gray-400 mt-2">
          The display will show sponsors in a carousel with fade in/out effects
      ...
      {(showAddForm || editingSponsor) && (
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          <div className="flex justify-end space-x-3 mt-6">
            <button
              onClick={
                editingSponsor ? handleCancelEdit : () => setShowAddForm(false)
              }
            ...
            <div key={sponsor.id} className="bg-gray-800 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-gray-400">
                  Priority: {sponsor.displayPriority}
                </span>
              </div>
