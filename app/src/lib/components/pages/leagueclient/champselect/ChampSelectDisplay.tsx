          ...
          <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3">
            <div className="text-center">
              ...
              <div className="font-semibold text-white">
                {tournamentData.blueTeam.coach.name}
              </div>
            </div>
          </div>
        )}
        {tournamentData?.redTeam?.coach && (
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-3">
            <div className="text-center">
              <div className="text-sm text-gray-400 mb-1">COACH</div>
              <div className="font-semibold text-white">
                {tournamentData.redTeam.coach.name}
              </div>
            </div>
          </div>
        )}
          ...
          <>
            <div className="flex justify-between mb-2 items-center">
              <TeamBans
                ...
                teamColor={
                  tournamentData?.blueTeam?.colors?.primary || blueColor
                }
                ...
                <FearlessDraftBans
                  ...
                  customTeamColors={{
                    blueTeam:
                      tournamentData?.blueTeam?.colors?.primary || blueColor,
                    redTeam:
                      tournamentData?.redTeam?.colors?.primary || redColor,
                  }}
                />
              )}
              <TeamBans
      ...
      <div className="relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-300 text-lg">
            This demo showcases the dynamic pick/ban mock system with real-time
            updates
          </p>
        </div>
