...
export const FearlessDraftBans: React.FC<FearlessDraftBansProps> = ({
  customTeamColors,
  bans,
}) => {
  const ROLE_ORDER: FearlessBan["role"][] = [
    "TOP",
    "JUNGLE",
    "MID",
    "ADC",
              ...
              >
                {redBans[idx] ? (
                  <Image
                    ...
                    width={32}
                    src={
                      getChampionSquareImage(redBans[idx].championId) as string
                    }
