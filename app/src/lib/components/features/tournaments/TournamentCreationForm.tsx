      ...
      <form onSubmit={handleCreateTournament} className="space-y-4">
        ...
        {(formData.tournamentFormat === "Swiss into Ladder" ||
          ...
          <div className="border border-gray-600 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-400 mt-2">
              Configure different match formats for each tournament phase. This allows for progressive intensity (e.g.,
                    ...
                    reader.onload = (event) => {
                      ...
                      setFormData({
                        ...
                        logo: {
                          ...
                          data: result,
                          size: file.size,
                          format: file.type.includes("png") ? "png" : file.type.includes("webp") ? "webp" : "jpg"
                        }
                      });
                    };
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Champions picked/banned in previous games cannot be used again in the series
          </p>
        </div>
