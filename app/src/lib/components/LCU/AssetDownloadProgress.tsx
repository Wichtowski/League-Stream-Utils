...
const getAssetTypeLabel = (assetType?: string): string => {
  switch (assetType) {
    case 'champion-data': return 'Champions';
    case 'champion-images': return 'Champion Images';
    case 'ability-images': return 'Abilities';
    case 'item-data': return 'Items';
    case 'item-images': return 'Item Images';
    case 'spell-data': return 'Spells';
    case 'spell-images': return 'Spell Images';
    case 'rune-data': return 'Runes';
    case 'rune-images': return 'Rune Images';
    default: return 'Assets';
  }
};

export const AssetDownloadProgress: React.FC<AssetDownloadProgressProps> = ({
  progress,
  onCancel,
  className = ''
}) => {
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center space-x-2 bg-gray-700/50 rounded-full px-3 py-1">
              <div className={`w-2 h-2 rounded-full ${
                progress.stage === 'checking' ? 'bg-yellow-400' :
                progress.stage === 'downloading' ? 'bg-blue-400' :
