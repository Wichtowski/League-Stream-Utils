...
export const LocalDatabaseManager = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        <div className={`p-3 rounded ${message.type === 'success' ? 'bg-green-900/30 border border-green-600/50 text-green-200' : 'bg-red-900/30 border border-red-600/50 text-red-200'}`}>
          {message.text}
          <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800/50 rounded-lg p-4">
          ...
          <div className="space-y-2">
            ...
            {backups.length === 0 && (
              <div className="text-gray-400 text-center py-4">No backups found</div>
            )}
          </div>
        </div>
      </div>
