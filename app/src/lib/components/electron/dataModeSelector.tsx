                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <div className="mt-2 p-2 bg-green-900/30 border border-green-600/50 rounded text-green-200 text-xs">
                                <strong>Note:</strong> Local data mode uses MongoDB Memory Server. No system MongoDB
                                installation required - the app will automatically start a local MongoDB instance.
                            </div>
                ...
                >
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm mt-1">
                                Use the web-based system with Cloud storage. Requires user registration and internet
                                connection. Data is stored in the cloud and accessible from anywhere.
                            </p>
                            <div className="flex items-center space-x-4 mt-2 text-xs">
            ...
            {useLocalData && (
                <div className="mt-4 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                    <p className="text-green-400 text-sm">
                        <strong>Local Mode Active:</strong> All data will be saved to your computer&apos;s AppData
                        folder. You&apos;re automatically logged in as a local administrator.
                    </p>
                </div>
            )}
        </div>
