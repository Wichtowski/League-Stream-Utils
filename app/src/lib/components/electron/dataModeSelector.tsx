  ...
  return (
    <div className="bg-gray-800/40 backdrop-blur-md rounded-xl p-6 border border-gray-700/50">
      ...
      <p className="text-gray-400 mb-6">
        Choose how you want to store your tournament data in the desktop
        application.
      </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Store all data locally on your computer (%appdata%). No internet
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Use the web-based system with Cloud storage. Requires user
                registration and internet connection. Data is stored in the
                cloud and accessible from anywhere.
              </p>
              <div className="flex items-center space-x-4 mt-2 text-xs">
      ...
      {useLocalData && (
        <div className="mt-4 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
          <p className="text-green-400 text-sm">
            <strong>Local Mode Active:</strong> All data will be saved to your
            computer&apos;s AppData folder. You&apos;re automatically logged in
