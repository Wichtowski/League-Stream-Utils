...
export function AlertModal({ isOpen, onClose, title, message, type = 'info', timeout }: AlertModalProps) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={title} showCloseButton={false}>
            <div className="text-center">
                {getIcon()}
                <p className="text-gray-300 mb-6 text-base leading-relaxed">{message}</p>
