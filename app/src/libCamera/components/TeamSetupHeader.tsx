...
export const TeamSetupHeader = ({ teamId, teamName, teamLogo, saving, onSave }: TeamSetupHeaderProps): React.ReactElement => {
  return (
    <div className="flex justify-between items-center mb-8">
      <div className="flex items-center gap-4">
        {teamLogo ? (
          ...
          <div className="w-16 h-16 bg-gray-600 rounded-lg flex items-center justify-center text-gray-400 text-2xl">👥</div>
        )}
        <div>
      ...
      <div className="flex gap-3">
        ...
        />
        <button onClick={onSave} disabled={saving} className="bg-green-600 hover:bg-green-700 disabled:bg-gray-600 text-white px-6 py-2 rounded-lg transition-colors">
