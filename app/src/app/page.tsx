            ...
            <section className="relative py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                        Complete esports tournament platform with pick/ban system, team management, streaming
                        integration, and professional broadcasting tools.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                            ...
                            <p className="text-gray-300">
                                Professional draft interface with real-time synchronization, timer management, and
                        ...
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                            ...
                            <p className="text-gray-300">
                                OBS automation, camera management, and professional broadcast overlays for seamless
                                streaming.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                            ...
                            <p className="text-gray-300">
                                Bracket generation, scheduling, registration management, and comprehensive tournament
                                administration.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                            ...
                            <p className="text-gray-300">
                                Detailed statistics, pick/ban rates, win rates, and performance analytics across
                                tournaments.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                            ...
                            <p className="text-gray-300">
                                Native desktop app with enhanced features, local storage, and advanced tournament
                                templates.
                            </p>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <p className="text-gray-400 text-sm">
                            {new Date().getFullYear()} Oskar Wichtowski - League Stream Utils. Professional tournament
                            management platform.
                        </p>
                    </div>
                </div>
