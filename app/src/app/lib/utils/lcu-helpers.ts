...
// Test LCU connection
export const testLCUConnection = async (credentials: LCUCredentials): Promise<LCURequestResult<{ displayName: string; summonerLevel: number; profileIconId: number }>> => {
...
// Get gameflow phase
export const getGameflowPhase = async (credentials: LCUCredentials): Promise<LCURequestResult<string>> => {
