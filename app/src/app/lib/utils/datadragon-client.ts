...
export class DataDragonClient {
     ...
     */
    static async getChampion(championKey: string, version?: string): Promise<DataDragonResponse<Record<string, unknown>>> {
    ...
    static getImageUrls(version: string) {
        return {
            champion: {
                ...
                splash: (championKey: string, skinNum: number = 0) => `${DDRAGON_CDN}/img/champion/splash/${championKey}_${skinNum}.jpg`,
                splashCentered: (championKey: string, skinNum: number = 0) => `${DDRAGON_CDN}/img/champion/centered/${championKey}_${skinNum}.jpg`,
                loading: (championKey: string, skinNum: number = 0) => `${DDRAGON_CDN}/img/champion/loading/${championKey}_${skinNum}.jpg`,
