...
export default function TeamsPage() {
  ...
  const { teams, loading, createTeam, verifyPlayer, verifyAllPlayers, refreshTeams } = useTeams();
  ...
  return (
    ...
    >
      {showCreateForm && (
        <TeamCreationForm onSubmit={handleCreateTeam} onCancel={() => setShowCreateForm(false)} isCreating={creating} />
      )}
