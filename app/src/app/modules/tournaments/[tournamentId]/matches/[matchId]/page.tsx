              ...
              <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-700">
                ...
                {match.scheduledTime && (
                  <div className="col-span-2">
                    ...
                    <div className="text-white font-medium">{new Date(match.scheduledTime).toLocaleString()}</div>
                  </div>
                )}
                {match.roundName && (
                  <div className="col-span-2">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-gray-400">
                    Format: <span className="text-white">{tournament.tournamentFormat}</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {match.commentators.map((commentator) => (
                    <div key={commentator.id} className="flex items-center justify-between">
                      <div>
                        ...
                        {commentator.xHandle && <div className="text-blue-400 text-sm">{commentator.xHandle}</div>}
                      </div>
  ...
  return (
    <div className="bg-gray-700 rounded-lg p-4">
      ...
      <div className="mt-3 text-center">
        <div className="text-white font-medium">{game.winner === "blue" ? "Blue Team" : "Red Team"} wins</div>
      </div>
    </div>
  );
}
