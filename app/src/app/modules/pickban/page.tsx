...
export default function PickBanPage(): React.ReactElement {
  ...
  return (
    <PageWrapper
      requireAuth={false}
      breadcrumbs={[
        { label: "Pick & Ban", href: "/modules/pickban", isActive: true },
      ]}
      title="Pick & Ban Hub"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
        ...
        <div className={`${!isElectron ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-700 cursor-pointer hover:border-purple-500"} bg-gray-800 rounded-xl p-6 transition-colors border border-gray-700`}
             onClick={() => {
              if (isElectron) {
          ...
          <div className="text-center">
            <div className={`w-16 h-16 ${isElectron ? "bg-purple-600" : "bg-gray-600"} rounded-full mx-auto mb-4 flex items-center justify-center`}>
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-gray-400 mb-4">
              ...
              {!isElectron && (
                <span className="block text-sm text-yellow-400 mt-2">
                  ⚠️ Only available in Electron desktop app
                </span>
              )}
            </p>
