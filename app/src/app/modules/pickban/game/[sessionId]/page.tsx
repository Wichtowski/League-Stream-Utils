                        ...
                        {filteredChampions.map((champion) => {
                            ...
                            return (
                                <button
                                    key={champion.id}
                                    onClick={() =>
                                        canAct && currentAction && handleChampionAction(champion.id, currentAction)
                                    }
                                    onMouseEnter={() =>
                                        currentAction &&
                                        handleChampionHover(champion.id, currentAction as 'pick' | 'ban')
                                    }
                                    onMouseLeave={() =>
                                        currentAction && handleChampionHover(null, currentAction as 'pick' | 'ban')
                                    }
                                    disabled={disabled}
