...
export default function GamePage({ params }: { params: Promise<{ sessionId: string }> }) {
    ...
    return (
      ...
      >
        <div className="text-center">
          <div className="text-white text-2xl font-semibold">Redirecting to configuration...</div>
        </div>
      </PageWrapper>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-blue-900/40 to-blue-600/20 backdrop-blur-lg rounded-3xl p-8 border border-blue-500/30 shadow-2xl">
            <div className="text-center">
              ...
              <div className={`mt-4 text-lg ${gameState.teams.blue.isReady ? "text-green-400" : "text-gray-400"}`}>
          ...
          <div className="bg-gradient-to-br from-red-900/40 to-red-600/20 backdrop-blur-lg rounded-3xl p-8 border border-red-500/30 shadow-2xl">
            <div className="text-center">
              ...
              <div className={`mt-4 text-lg ${gameState.teams.red.isReady ? "text-green-400" : "text-gray-400"}`}>
  ...
  return (
    <PageWrapper
      ...
      actions={
        <div className="flex items-center space-x-6">
          <div className={`px-3 py-1 rounded-full text-sm font-medium ${connected ? "bg-green-600" : "bg-red-600"}`}>
          ...
          <div className="text-right">
            ...
            {teamSide && (
              <div
                className={`px-3 py-1 rounded mt-2 inline-block ${teamSide === "blue" ? "bg-blue-600" : "bg-red-600"}`}
              >
    ...
    >
      {error && <div className="bg-red-600 text-white p-4 text-center font-semibold">{error}</div>}
        ...
        <div className="mb-8">
                      ...
                      <div
                        ...
                        className={`relative w-16 h-16 rounded-xl overflow-hidden border-2 transition-all duration-300 ${
                          ban
                            ...
                            : "border-gray-600 border-dashed opacity-50"
                        }`}
                      >
                        {ban ? (
                          <>
          ...
          {gameState.currentTurn && (
            <div className="mt-8 text-center">
              <div
                className={`inline-block px-8 py-4 rounded-2xl font-bold text-xl shadow-2xl ${
            ...
            {filteredChampions.map((champion) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={() =>
                    currentAction && handleChampionHover(champion.id, currentAction as "pick" | "ban")
                  }
                ...
                >
                  <Image
                    ...
                    src={champion.image}
                    alt={champion.name}
                    className={`w-full h-full object-cover rounded-xl ${status?.includes("ban") ? "grayscale" : ""}`}
                  />
