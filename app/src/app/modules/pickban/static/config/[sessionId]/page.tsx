        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Standard tournament format (3 bans, 5 picks each)</p>
                </div>
              </label>
              <label className="flex items-center">
                <input
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Ranked game format (5 bans, 5 picks each)</p>
                </div>
              </label>
              <label className="flex items-center">
                <input
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Configure your own format</p>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Blue Team Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Red Team Name</label>
                <input
                  type="text"
          ...
          {config.format === "custom" && (
            <div className="bg-gray-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold mb-4">Custom Format Settings</h2>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Ban Phases</label>
                  <input
                    type="number"
                    min="1"
                    max="5"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Pick Phases</label>
                  <input
                    type="number"
                    min="1"
                    max="5"
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Time per Action (seconds)</label>
                <input
                  type="number"
                  min="10"
                  max="300"
                  ...
                  className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 border border-gray-600 focus:border-blue-500"
                />
                <p className="text-xs text-gray-400 mt-1">Set to 0 for no timer</p>
              </div>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2"
                />
                <span className="text-sm">Auto-advance to next phase when timer expires</span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>{config.timePerAction > 0 ? `${config.timePerAction}s` : "No timer"}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-blue-900/30 rounded-lg p-6 border border-blue-600">
            ...
            <div className="text-sm text-gray-300 space-y-1">
              ...
              {config.format === "custom" && (
                <p>
                  Custom format with {config.banPhases} ban phases and {config.pickPhases} pick phases
                </p>
              )}
            </div>
          </div>
