                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, banPhases: parseInt(e.target.value) }))}
                      className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 border border-gray-600 focus:border-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, pickPhases: parseInt(e.target.value) }))}
                      className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 border border-gray-600 focus:border-blue-500"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setConfig(prev => ({ ...prev, timePerAction: parseInt(e.target.value) }))}
                    className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 border border-gray-600 focus:border-blue-500"
                  />
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setConfig(prev => ({ ...prev, allowUndo: e.target.checked }))}
                    className="mr-2"
                  />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-900/30 rounded-lg p-6 border border-blue-600">
              ...
              <div className="text-sm text-gray-300 space-y-1">
                ...
                {config.format === 'custom' && (
                  <p>Custom format with {config.banPhases} ban phases and {config.pickPhases} pick phases</p>
                )}
              </div>
            </div>
