    ...
    <div className="min-h-screen  text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold">{session.name || `Session ${sessionId}`}</h1>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-400">
                {currentPhase === 'finished' ? 'Draft Complete!' : 
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-5 gap-2">
                {Array.from({ length: 5 }, (_, i) => {
                  ...
                  return (
                    <div key={i} className="aspect-square bg-gray-800 rounded border border-gray-600 overflow-hidden relative">
                      {champion ? (
                        <>
                          <Image
                            src={champion.image}
