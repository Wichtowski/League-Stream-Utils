  ...
  const handleTeamSelect = useCallback((side: "blue" | "red", team: Team) => {
    if (side === "blue") {
      ...
      setConfig((prev) => ({
        ...
        blueCoach: team.staff?.coach
          ? { name: team.staff.coach.name }
          : undefined,
      }));
    } else {
            ...
            <div>
              ...
              >
                ...
                {tournaments
                  .filter(
                    (tournament) =>
                      user?.isAdmin || tournament.userId === user?.id,
                  )
                  .map((tournament) => (
          ...
          {selectedTournament && (
            <div className="mt-4 p-4 bg-purple-900/30 rounded-lg border border-purple-700/50">
              <p className="text-sm text-purple-300">
                <strong>Tournament Selected:</strong>{" "}
          ...
          >
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  const newSeriesType = e.target.value as
                    | "BO1"
                    | "BO3"
                    | "BO5";
                  setConfig((prev) => ({
                    ...
                    isFearlessDraft:
                      newSeriesType === "BO1" ? false : prev.isFearlessDraft,
                  }));
                }}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={
                    !!selectedBlueTeam && !!selectedBlueTeam.logo?.data
                  }
                  className="w-full px-3 py-2 bg-gray-700 rounded text-white border border-gray-600 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div>
                ...
                <input
                  ...
                  disabled={
                    !!selectedBlueTeam &&
                    !!selectedBlueTeam.staff?.coach?.name
                  }
                  className="w-full px-3 py-2 bg-gray-700 rounded text-white border border-gray-600 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig((prev) => ({
                      ...prev,
                      redCoach: e.target.value
                        ? { name: e.target.value }
                        : undefined,
                    }))
                  }
                  disabled={
                    !!selectedRedTeam && !!selectedRedTeam.staff?.coach?.name
                  }
                  className="w-full px-3 py-2 bg-gray-700 rounded text-white border border-gray-600 focus:border-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  placeholder="Enter coach name"
                />
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 text-blue-400">
                {config.blueTeamName || "Blue Team"}
              </span>
            </div>
            <div>
              <span className="text-gray-400">Red Team:</span>
              <span className="ml-2 text-red-400">
                {config.redTeamName || "Red Team"}
              </span>
            </div>
            <div className="col-span-2">
              <span className="text-gray-400">Fearless Draft:</span>
              <span
                className={`ml-2 ${config.isFearlessDraft ? "text-green-400" : "text-gray-400"}`}
              >
