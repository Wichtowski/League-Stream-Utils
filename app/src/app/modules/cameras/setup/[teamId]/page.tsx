          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Configure stream URLs for {team.players.length} players
              </p>
            </div>
          </div>
        ...
        <div className="mb-8 bg-gray-800 rounded-lg p-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-white font-medium">
              Stream Configuration Progress
            </span>
            <span className="text-blue-400">
              {team.players.filter((p) => p.url && p.url.trim() !== "").length}{" "}
              / {team.players.length}
            </span>
          </div>
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Single stream representing the whole team
                </p>
              </div>
              <div
                className={`w-3 h-3 rounded-full ${team.teamStreamUrl && team.teamStreamUrl.trim() !== "" ? "bg-green-500" : "bg-gray-500"}`}
              ></div>
            </div>
          ...
          {team.players.map((player) => (
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div
                  className={`w-3 h-3 rounded-full ${player.url && player.url.trim() !== "" ? "bg-green-500" : "bg-gray-500"}`}
                ></div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={player.url || ""}
                    onChange={(e) =>
                      updatePlayerUrl(player.playerId || "", e.target.value)
                    }
                    className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none transition-colors"
                  />
                </div>
            ...
            <div className="space-y-4">
              <div className="bg-red-600/10 border border-red-600/30 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-300 mb-3">
                  For competitive integrity, set up delayed streams when not
                  using official spectator mode:
                </p>
              ...
              <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4">
                ...
                <ul className="text-xs text-gray-400 space-y-1">
                  <li>
                    • Test both live and delayed streams before tournaments
                  </li>
