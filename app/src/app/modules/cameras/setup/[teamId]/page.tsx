            ...
            const loadTeamSettings = async () => {
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (fullTeam) {
                            const allPlayers = [...fullTeam.players.main, ...fullTeam.players.substitutes].map(
                                (player) => {
                        ...
                        <div className="space-y-4">
                            <div className="bg-red-600/10 border border-red-600/30 rounded-lg p-4">
                                ...
                                <p className="text-sm text-gray-300 mb-3">
                                    For competitive integrity, set up delayed streams when not using official spectator
                                    mode:
                                </p>
