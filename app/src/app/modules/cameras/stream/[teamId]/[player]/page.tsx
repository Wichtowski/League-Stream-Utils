        ...
        <AuthGuard loadingMessage="Loading player camera...">
            ...
            {accessDenied ? (
                <CameraLayout>
                    <div className="flex items-center justify-center p-8 h-screen">
                        <div className="text-center">
                            ...
                            <p className="text-gray-400 mb-6">{accessReason}</p>
                    ...
                    <div className="flex items-center justify-center p-8 h-screen">
                        <div className="text-center">
                            ...
                            <p className="text-gray-400 mb-6">
                                {teamName
                                    ? `Player "${playerName}" not found in ${teamName}`
                ...
                <Suspense fallback={<div>Loading...</div>}>
                    <CameraLayout>
                        <PlayerInfoHeader player={player} teamName={teamName} position="top-left" size="large" />

                        <CameraNavigation position="top-right" showHub={true} showTeamView={true} teamId={teamId} />
