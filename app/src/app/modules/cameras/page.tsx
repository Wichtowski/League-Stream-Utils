    ...
    >
                  ...
                  <ul className="text-xs mt-1">
                    {team.players.main.map((p) => (
                      <li
                        key={p.id}
                        className={
                          p.cameraUrl ? "text-green-400" : "text-yellow-400"
                        }
                      >
                        {p.inGameName}{" "}
                        {p.cameraUrl ? "• Configured" : "• Not Configured"}
                      </li>
                    ))}
      ...
      <div className="mt-8 bg-gray-800 rounded-lg p-4 border border-gray-700">
        ...
        <div className="text-sm text-gray-300 space-y-1 flex flex-row gap-2">
          ...
          <p>
            <kbd className="bg-gray-600 px-2 py-1 rounded">R</kbd> - Toggle
            auto-random mode
          </p>
          <p>
            <kbd className="bg-gray-600 px-2 py-1 rounded">1-9</kbd> - Select
            specific player
          </p>
        </div>
      </div>
