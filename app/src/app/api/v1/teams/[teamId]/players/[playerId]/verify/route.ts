...
export const POST = withAuth(async (req: NextRequest, user: JWTPayload) => {
    try {
        ...
        const player = [...team.players.main, ...team.players.substitutes]
        ...
        if (player.inGameName.toLowerCase() !== gameName.toLowerCase() ||
        ...
        const verificationResult = await riotAPI.verifyPlayer(gameName, tagLine, player.puuid);
