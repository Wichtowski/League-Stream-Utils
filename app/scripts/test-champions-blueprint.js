...
const {
  championsBlueprintDownloader,
} = require("../src/lib/services/champions-blueprint-downloader");
...
async function testChampionsBlueprint() {
  ...
  try {
    ...
    console.log("\n2. Downloading champions blueprint for version 15.13.1...");
    await championsBlueprintDownloader.downloadChampionsBlueprint("15.13.1");
    console.log("✅ Champions blueprint for 15.13.1 downloaded successfully!");
